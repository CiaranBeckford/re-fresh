...
//  Edited by Ciaran Beckford on 12/20/20
...
public struct CodeScannerView: UIViewControllerRepresentable {
    ...
    public init(codeTypes: [AVMetadataObject.ObjectType], scanMode: ScanMode = .oncePerCode, scanInterval: Double = 2.0, simulatedData: String = "", completion: @escaping (Result<String, ScanError>) -> Void) {
